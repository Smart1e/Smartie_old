...
def authenticate():
    pasin = '?'
    while pasin == '?':
        f = open("BaseSkelotenConduct.txt", "r")
        letin = f.read()
        ...
        if pasin == letin:
            ...
            f.close()
            '''
            os.startfile('BaseSkelotenConduct.txt')
...
def main():
    ...
    if inputString != '':
        ...
        elif 'halt' in inputString or 'wait' in inputString:
            authenticate()
        ...
        elif 'log off' in inputString or 'logoff' in inputString or 'log me off' in inputString:
